...
a_fft_78 <- a_fft_78 %>% mutate(`AA-1`= 5- `AA-1`+1)
a_fft_78 <- a_fft_78 %>% mutate(`AA-3`= 5- `AA-3`+1)
a_fft_78 <- a_fft_78 %>% mutate(`AA-5`= 5- `AA-5`+1)
a_fft_78 <- a_fft_78 %>% mutate(`EA-1`= 5- `EA-1`+1)
a_fft_78 <- a_fft_78 %>% mutate(`EA-2`= 5- `EA-2`+1)
a_fft_78 <- a_fft_78 %>% mutate(`EA-4`= 5- `EA-4`+1)
a_fft_78 <- a_fft_78 %>% mutate(`EA-5`= 5- `EA-5`+1)
a_fft_78 <- a_fft_78 %>% mutate(`FA-2`= 5- `FA-2`+1)
a_fft_78 <- a_fft_78 %>% mutate(`AFTRS-3`= 5- `AFTRS-3`+1)
a_fft_78 <- a_fft_78 %>% mutate(`AFTRS-6`= 5- `AFTRS-6`+1)
a_fft_78 <- a_fft_78 %>% mutate(`AFTRS-8`= 5- `AFTRS-8`+1)
a_fft_78 <- a_fft_78 %>% mutate(`AFTRS-10`= 5- `AFTRS-10`+1)
a_fft_78 <- a_fft_78 %>% mutate(`AFTRS-11`= 5- `AFTRS-11`+1)
a_fft_78 <- a_fft_78 %>% mutate(`AFTRS-13`= 5- `AFTRS-13`+1)
a_fft_78 <- a_fft_78 %>% mutate(`AFTRS-14`= 5- `AFTRS-14`+1)
a_fft_78 <- a_fft_78 %>% mutate(`AFTRS-15`= 5- `AFTRS-15`+1)
